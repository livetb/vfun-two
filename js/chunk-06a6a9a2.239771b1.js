 ...
 */function ee(e){var t=e.projectId;return q+"/projects/"+t+"/installations"}function te(e){return{token:e.token,requestStatus:2,expiresIn:oe(e.expiresIn),creationTime:Date.now()}}function ne(e,t){return x(this,void 0,void 0,(function(){var n,r;return V(this,(function(i){switch(i.label){case 0:return[4,t.json()];case 1:return n=i.sent(),r=n.error,[2,_.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})]}}))}))}function re(e){var t=e.apiKey;return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function ie(e,t){var n=t.refreshToken,r=re(e);return r.append("Authorization",se(n)),r}function ae(e){return x(this,void 0,void 0,(function(){var t;return V(this,(function(n){switch(n.label){case 0:return[4,e()];case 1:return t=n.sent(),t.status>=500&&t.status<600?[2,e()]:[2,t]}}))}))}function oe(e){return Number(e.replace("s","000"))}function se(e){return M+" "+e}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ue(e,t){var n=t.fid;return x(this,void 0,void 0,(function(){var t,r,i,a,o,s,u;return V(this,(function(c){switch(c.label){case 0:return t=ee(e),r=re(e),i={fid:n,authVersion:M,appId:e.appId,sdkVersion:H},a={method:"POST",headers:r,body:JSON.stringify(i)},[4,ae((function(){return fetch(t,a)}))];case 1:return o=c.sent(),o.ok?[4,o.json()]:[3,3];case 2:return s=c.sent(),u={fid:s.fid||n,registrationStatus:2,refreshToken:s.refreshToken,authToken:te(s.authToken)},[2,u];case 3:return[4,ne("Create Installation",o)];case 4:throw c.sent()}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function le(e){var t=btoa(String.fromCharCode.apply(String,j(e)));return t.replace(/\+/g,"-").replace(/\//g,"_")}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var fe=/^[cdef][\w-]{21}$/,de="";function pe(){try{var e=new Uint8Array(17),t=self.crypto||self.msCrypto;t.getRandomValues(e),e[0]=112+e[0]%16;var n=he(e);return fe.test(n)?n:de}catch(r){return de}}function he(e){var t=le(e);return t.substr(0,22)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ae=new Map;function be(e,t){var n=ve(e);Se(n,t),ye(n,t)}function ge(e,t){ke();var n=ve(e),r=Ae.get(n);r||(r=new Set,Ae.set(n,r)),r.add(t)}function me(e,t){var n=ve(e),r=Ae.get(n);r&&(r.delete(t),0===r.size&&Ae.delete(n),Ie())}function Se(e,t){var n,r,i=Ae.get(e);if(i)try{for(var a=W(i),o=a.next();!o.done;o=a.next()){var s=o.value;s(t)}}catch(u){n={error:u}}finally{try{o&&!o.done&&(r=a.return)&&r.call(a)}finally{if(n)throw n.error}}}function ye(e,t){var n=ke();n&&n.postMessage({key:e,fid:t}),Ie()}var we=null;function ke(){return!we&&"BroadcastChannel"in self&&(we=new BroadcastChannel("[Firebase] FID Change"),we.onmessage=function(e){Se(e.data.key,e.data.fid)}),we}function Ie(){0===Ae.size&&we&&(we.close(),we=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ce="firebase-installations-database",Ee=1,Oe="firebase-installations-store",Te=null;function De(){return Te||(Te=Object(Q["openDb"])(Ce,Ee,(function(e){switch(e.oldVersion){case 0:e.createObjectStore(Oe)}}))),Te}function Je(e,t){return x(this,void 0,void 0,(function(){var n,r,i,a,o;return V(this,(function(s){switch(s.label){case 0:return n=ve(e),[4,De()];case 1:return r=s.sent(),i=r.transaction(Oe,"readwrite"),a=i.objectStore(Oe),[4,a.get(n)];case 2:return o=s.sent(),[4,a.put(t,n)];case 3:return s.sent(),[4,i.complete];case 4:return s.sent(),o&&o.fid===t.fid||be(e,t.fid),[2,t]}}))}))}function Be(e){return x(this,void 0,void 0,(function(){var t,n,r;return V(this,(function(i){switch(i.label){case 0:return t=ve(e),[4,De()];case 1:return n=i.sent(),r=n.transaction(Oe,"readwrite"),[4,r.objectStore(Oe).delete(t)];case 2:return i.sent(),[4,r.complete];case 3:return i.sent(),[2]}}))}))}function Re(e,t){return x(this,void 0,void 0,(function(){var n,r,i,a,o,s;return V(this,(function(u){switch(u.label){case 0:return n=ve(e),[4,De()];case 1:return r=u.sent(),i=r.transaction(Oe,"readwrite"),a=i.objectStore(Oe),[4,a.get(n)];case 2:return o=u.sent(),s=t(o),void 0!==s?[3,4]:[4,a.delete(n)];case 3:return u.sent(),[3,6];case 4:return[4,a.put(s,n)];case 5:u.sent(),u.label=6;case 6:return[4,i.complete];case 7:return u.sent(),!s||o&&o.fid===s.fid||be(e,s.fid),[2,s]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(e){return x(this,void 0,void 0,(function(){var t,n,r;return V(this,(function(i){switch(i.label){case 0:return[4,Re(e,(function(n){var r=xe(n),i=Ve(e,r);return t=i.registrationPromise,i.installationEntry}))];case 1:return n=i.sent(),n.fid!==de?[3,3]:(r={},[4,t]);case 2:return[2,(r.installationEntry=i.sent(),r)];case 3:return[2,{installationEntry:n,registrationPromise:t}]}}))}))}function xe(e){var t=e||{fid:pe(),registrationStatus:0};return Fe(t)}function Ve(e,t){if(0===t.registrationStatus){if(!navigator.onLine){var n=Promise.reject(_.create("app-offline"));return{installationEntry:t,registrationPromise:n}}var r={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=We(e,r);return{installationEntry:r,registrationPromise:i}}return 1===t.registrationStatus?{installationEntry:t,registrationPromise:Pe(e)}:{installationEntry:t}}function We(e,t){return x(this,void 0,void 0,(function(){var n,r;return V(this,(function(i){switch(i.label){case 0:return i.trys.push([0,2,,7]),[4,ue(e,t)];case 1:return n=i.sent(),[2,Je(e,n)];case 2:return r=i.sent(),$(r)&&409===r.customData.serverCode?[4,Be(e)]:[3,4];case 3:return i.sent(),[3,6];case 4:return[4,Je(e,{fid:t.fid,registrationStatus:0})];case 5:i.sent(),i.label=6;case 6:throw r;case 7:return[2]}}))}))}function Pe(e){return x(this,void 0,void 0,(function(){var t,n,r,i;return V(this,(function(a){switch(a.label){case 0:return[4,je(e)];case 1:t=a.sent(),a.label=2;case 2:return 1!==t.registrationStatus?[3,5]:[4,ce(100)];case 3:return a.sent(),[4,je(e)];case 4:return t=a.sent(),[3,2];case 5:return 0!==t.registrationStatus?[3,7]:[4,Ne(e)];case 6:return n=a.sent(),r=n.installationEntry,i=n.registrationPromise,i?[2,i]:[2,r];case 7:return[2,t]}}))}))}function je(e){return Re(e,(function(e){if(!e)throw _.create("installation-not-found");return Fe(e)}))}function Fe(e){return Ke(e)?{fid:e.fid,registrationStatus:0}:e}function Ke(e){return 1===e.registrationStatus&&e.registrationTime+z<Date.now()}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e,t){var n=e.appConfig,r=e.platformLoggerProvider;return x(this,void 0,void 0,(function(){var e,i,a,o,s,u,c,l;return V(this,(function(f){switch(f.label){case 0:return e=Ue(n,t),i=ie(n,t),a=r.getImmediate({optional:!0}),a&&i.append("x-firebase-client",a.getPlatformInfoString()),o={installation:{sdkVersion:H}},s={method:"POST",headers:i,body:JSON.stringify(o)},[4,ae((function(){return fetch(e,s)}))];case 1:return u=f.sent(),u.ok?[4,u.json()]:[3,3];case 2:return c=f.sent(),l=te(c),[2,l];case 3:return[4,ne("Generate Auth Token",u)];case 4:throw f.sent()}}))}))}function Ue(e,t){var n=t.fid;return ee(e)+"/"+n+"/authTokens:generate"}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Le(e,t){return void 0===t&&(t=!1),x(this,void 0,void 0,(function(){var n,r,i,a;return V(this,(function(o){switch(o.label){case 0:return[4,Re(e.appConfig,(function(r){if(!qe(r))throw _.create("not-registered");var i=r.authToken;if(!t&&Ze(i))return r;if(1===i.requestStatus)return n=ze(e,t),r;if(!navigator.onLine)throw _.create("app-offline");var a=Ye(r);return n=Me(e,a),a}))];case 1:return r=o.sent(),n?[4,n]:[3,3];case 2:return a=o.sent(),[3,4];case 3:a=r.authToken,o.label=4;case 4:return i=a,[2,i]}}))}))}function ze(e,t){return x(this,void 0,void 0,(function(){var n,r;return V(this,(function(i){switch(i.label){case 0:return[4,He(e.appConfig)];case 1:n=i.sent(),i.label=2;case 2:return 1!==n.authToken.requestStatus?[3,5]:[4,ce(100)];case 3:return i.sent(),[4,He(e.appConfig)];case 4:return n=i.sent(),[3,2];case 5:return r=n.authToken,0===r.requestStatus?[2,Le(e,t)]:[2,r]}}))}))}function He(e){return Re(e,(function(e){if(!qe(e))throw _.create("not-registered");var t=e.authToken;return Xe(t)?N(N({},e),{authToken:{requestStatus:0}}):e}))}function Me(e,t){return x(this,void 0,void 0,(function(){var n,r,i;return V(this,(function(a){switch(a.label){case 0:return a.trys.push([0,3,,8]),[4,Qe(e,t)];case 1:return n=a.sent(),i=N(N({},t),{authToken:n}),[4,Je(e.appConfig,i)];case 2:return a.sent(),[2,n];case 3:return r=a.sent(),!$(r)||401!==r.customData.serverCode&&404!==r.customData.serverCode?[3,5]:[4,Be(e.appConfig)];case 4:return a.sent(),[3,7];case 5:return i=N(N({},t),{authToken:{requestStatus:0}}),[4,Je(e.appConfig,i)];case 6:a.sent(),a.label=7;case 7:throw r;case 8:return[2]}}))}))}function qe(e){return void 0!==e&&2===e.registrationStatus}function Ze(e){return 2===e.requestStatus&&!Ge(e)}function Ge(e){var t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Z}function Ye(e){var t={requestStatus:1,requestTime:Date.now()};return N(N({},e),{authToken:t})}function Xe(e){return 1===e.requestStatus&&e.requestTime+z<Date.now()}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(e){return x(this,void 0,void 0,(function(){var t,n,r;return V(this,(function(i){switch(i.label){case 0:return[4,Ne(e.appConfig)];case 1:return t=i.sent(),n=t.installationEntry,r=t.registrationPromise,r?r.catch(console.error):Le(e).catch(console.error),[2,n.fid]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(e,t){return void 0===t&&(t=!1),x(this,void 0,void 0,(function(){var n;return V(this,(function(r){switch(r.label){case 0:return[4,et(e.appConfig)];case 1:return r.sent(),[4,Le(e,t)];case 2:return n=r.sent(),[2,n.token]}}))}))}function et(e){return x(this,void 0,void 0,(function(){var t;return V(this,(function(n){switch(n.label){case 0:return[4,Ne(e)];case 1:return t=n.sent().registrationPromise,t?[4,t]:[3,3];case 2:n.sent(),n.label=3;case 3:return[2]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(e,t){return x(this,void 0,void 0,(function(){var n,r,i,a;return V(this,(function(o){switch(o.label){case 0:return n=nt(e,t),r=ie(e,t),i={method:"DELETE",headers:r},[4,ae((function(){return fetch(n,i)}))];case 1:return a=o.sent(),a.ok?[3,3]:[4,ne("Delete Installation",a)];case 2:throw o.sent();case 3:return[2]}}))}))}function nt(e,t){var n=t.fid;return ee(e)+"/"+n}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rt(e){return x(this,void 0,void 0,(function(){var t,n;return V(this,(function(r){switch(r.label){case 0:return t=e.appConfig,[4,Re(t,(function(e){if(!e||0!==e.registrationStatus)return e}))];case 1:if(n=r.sent(),!n)return[3,6];if(1!==n.registrationStatus)return[3,2];throw _.create("delete-pending-registration");case 2:if(2!==n.registrationStatus)return[3,6];if(navigator.onLine)return[3,3];throw _.create("app-offline");case 3:return[4,tt(t,n)];case 4:return r.sent(),[4,Be(t)];case 5:r.sent(),r.label=6;case 6:return[2]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function it(e,t){var n=e.appConfig;return ge(n,t),function(){me(n,t)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function at(e){var t,n;if(!e||!e.options)throw ot("App Configuration");if(!e.name)throw ot("App Name");var r=["projectId","apiKey","appId"];try{for(var i=W(r),a=i.next();!a.done;a=i.next()){var o=a.value;if(!e.options[o])throw ot(o)}}catch(s){t={error:s}}finally{try{a&&!a.done&&(n=i.return)&&n.call(i)}finally{if(t)throw t.error}}return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function ot(e){return _.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function st(e){var t="installations";e.INTERNAL.registerComponent(new R["a"](t,(function(e){var t=e.getProvider("app").getImmediate(),n=at(t),r=e.getProvider("platform-logger"),i={appConfig:n,platformLoggerProvider:r},a={app:t,getId:function(){return _e(i)},getToken:function(e){return $e(i,e)},delete:function(){return rt(i)},onIdChange:function(e){return it(i,e)}};return a}),"PUBLIC")),e.registerVersion(U,L)}st(B["a"]);var ut,ct,lt=n("abfd"),ft="firebase_id",dt="origin",pt=6e4,ht="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",vt="https://www.googletagmanager.com/gtag/js";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function At(e,t,n,r,i){return D(this,void 0,void 0,(function(){var a,o;return J(this,(function(s){switch(s.label){case 0:return i&&i.global?(e(ut.EVENT,n,r),[2]):[3,1];case 1:return[4,t];case 2:a=s.sent(),o=T(T({},r),{send_to:a}),e(ut.EVENT,n,o),s.label=3;case 3:return[2]}}))}))}function bt(e,t,n,r){return D(this,void 0,void 0,(function(){var i;return J(this,(function(a){switch(a.label){case 0:return r&&r.global?(e(ut.SET,{screen_name:n}),[2,Promise.resolve()]):[3,1];case 1:return[4,t];case 2:i=a.sent(),e(ut.CONFIG,i,{update:!0,screen_name:n}),a.label=3;case 3:return[2]}}))}))}function gt(e,t,n,r){return D(this,void 0,void 0,(function(){var i;return J(this,(function(a){switch(a.label){case 0:return r&&r.global?(e(ut.SET,{user_id:n}),[2,Promise.resolve()]):[3,1];case 1:return[4,t];case 2:i=a.sent(),e(ut.CONFIG,i,{update:!0,user_id:n}),a.label=3;case 3:return[2]}}))}))}function mt(e,t,n,r){return D(this,void 0,void 0,(function(){var i,a,o,s,u;return J(this,(function(c){switch(c.label){case 0:if(!r||!r.global)return[3,1];for(i={},a=0,o=Object.keys(n);a<o.length;a++)s=o[a],i["user_properties."+s]=n[s];return e(ut.SET,i),[2,Promise.resolve()];case 1:return[4,t];case 2:u=c.sent(),e(ut.CONFIG,u,{update:!0,user_properties:n}),c.label=3;case 3:return[2]}}))}))}function St(e,t){return D(this,void 0,void 0,(function(){var n;return J(this,(function(r){switch(r.label){case 0:return[4,e];case 1:return n=r.sent(),window["ga-disable-"+n]=!t,[2]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(e){var t=document.createElement("script");t.src=vt+"?l="+e,t.async=!0,document.head.appendChild(t)}function It(e){var t=[];return Array.isArray(window[e])?t=window[e]:window[e]=t,t}function Ct(e,t,n,r,i,a){return D(this,void 0,void 0,(function(){var o,s,u,c;return J(this,(function(l){switch(l.label){case 0:o=r[i],l.label=1;case 1:return l.trys.push([1,7,,8]),o?[4,t[o]]:[3,3];case 2:return l.sent(),[3,6];case 3:return[4,Promise.all(n)];case 4:return s=l.sent(),u=s.find((function(e){return e.measurementId===i})),u?[4,t[u.appId]]:[3,6];case 5:l.sent(),l.label=6;case 6:return[3,8];case 7:return c=l.sent(),wt.error(c),[3,8];case 8:return e(ut.CONFIG,i,a),[2]}}))}))}function Et(e,t,n,r,i){return D(this,void 0,void 0,(function(){var a,o,s,u,c,l,f,d,p;return J(this,(function(h){switch(h.label){case 0:return h.trys.push([0,4,,5]),a=[],i&&i["send_to"]?(o=i["send_to"],Array.isArray(o)||(o=[o]),[4,Promise.all(n)]):[3,2];case 1:for(s=h.sent(),u=function(e){var n=s.find((function(t){return t.measurementId===e})),r=n&&t[n.appId];if(!r)return a=[],"break";a.push(r)},c=0,l=o;c<l.length;c++)if(f=l[c],d=u(f),"break"===d)break;h.label=2;case 2:return 0===a.length&&(a=Object.values(t)),[4,Promise.all(a)];case 3:return h.sent(),e(ut.EVENT,r,i||{}),[3,5];case 4:return p=h.sent(),wt.error(p),[3,5];case 5:return[2]}}))}))}function Ot(e,t,n,r){function i(i,a,o){return D(this,void 0,void 0,(function(){var s;return J(this,(function(u){switch(u.label){case 0:return u.trys.push([0,6,,7]),i!==ut.EVENT?[3,2]:[4,Et(e,t,n,a,o)];case 1:return u.sent(),[3,5];case 2:return i!==ut.CONFIG?[3,4]:[4,Ct(e,t,n,r,a,o)];case 3:return u.sent(),[3,5];case 4:e(ut.SET,a),u.label=5;case 5:return[3,7];case 6:return s=u.sent(),wt.error(s),[3,7];case 7:return[2]}}))}))}return i}function Tt(e,t,n,r,i){var a=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];window[r].push(arguments)};return window[i]&&"function"===typeof window[i]&&(a=window[i]),window[i]=Ot(a,e,t,n),{gtagCore:a,wrappedGtag:window[i]}}function Dt(){for(var e=window.document.getElementsByTagName("script"),t=0,n=Object.values(e);t<n.length;t++){var r=n[t];if(r.src&&r.src.includes(vt))return r}return null}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Jt=(yt={},yt["already-exists"]="A Firebase Analytics instance with the appId {$id}  already exists. Only one Firebase Analytics instance can be created for each appId.",yt["already-initialized"]="Firebase Analytics has already been initialized.settings() must be called before initializing any Analytics instanceor it will have no effect.",yt["interop-component-reg-failed"]="Firebase Analytics Interop Component failed to instantiate: {$reason}",yt["invalid-analytics-context"]="Firebase Analytics is not supported in this environment. Wrap initialization of analytics in analytics.isSupported() to prevent initialization in unsupported environments. Details: {$errorInfo}",yt["indexeddb-unavailable"]="IndexedDB unavailable or restricted in this environment. Wrap initialization of analytics in analytics.isSupported() to prevent initialization in unsupported environments. Details: {$errorInfo}",yt["fetch-throttle"]="The config fetch request timed out while in an exponential backoff state. Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis}.",yt["config-fetch-failed"]="Dynamic config fetch failed: [{$httpStatus}] {$responseMessage}",yt["no-api-key"]='The "apiKey" field is empty in the local Firebase config. Firebase Analytics requires this field tocontain a valid API key.',yt["no-app-id"]='The "appId" field is empty in the local Firebase config. Firebase Analytics requires this field tocontain a valid app ID.',yt),Bt=new K["b"]("analytics","Analytics",Jt),Rt=30,Nt=1e3,xt=function(){function e(e,t){void 0===e&&(e={}),void 0===t&&(t=Nt),this.throttleMetadata=e,this.intervalMillis=t}return e.prototype.getThrottleMetadata=function(e){return this.throttleMetadata[e]},e.prototype.setThrottleMetadata=function(e,t){this.throttleMetadata[e]=t},e.prototype.deleteThrottleMetadata=function(e){delete this.throttleMetadata[e]},e}(),Vt=new xt;function Wt(e){return new Headers({Accept:"application/json","x-goog-api-key":e})}function Pt(e){var t;return D(this,void 0,void 0,(function(){var n,r,i,a,o,s,u;return J(this,(function(c){switch(c.label){case 0:return n=e.appId,r=e.apiKey,i={method:"GET",headers:Wt(r)},a=ht.replace("{app-id}",n),[4,fetch(a,i)];case 1:if(o=c.sent(),200===o.status||304===o.status)return[3,6];s="",c.label=2;case 2:return c.trys.push([2,4,,5]),[4,o.json()];case 3:return u=c.sent(),(null===(t=u.error)||void 0===t?void 0:t.message)&&(s=u.error.message),[3,5];case 4:return c.sent(),[3,5];case 5:throw Bt.create("config-fetch-failed",{httpStatus:o.status,responseMessage:s});case 6:return[2,o.json()]}}))}))}function jt(e,t,n){return void 0===t&&(t=Vt),D(this,void 0,void 0,(function(){var r,i,a,o,s,u,c=this;return J(this,(function(l){if(r=e.options,i=r.appId,a=r.apiKey,o=r.measurementId,!i)throw Bt.create("no-app-id");if(!a){if(o)return[2,{measurementId:o,appId:i}];throw Bt.create("no-api-key")}return s=t.getThrottleMetadata(i)||{backoffCount:0,throttleEndTimeMillis:Date.now()},u=new Ut,setTimeout((function(){return D(c,void 0,void 0,(function(){return J(this,(function(e){return u.abort(),[2]}))}))}),void 0!==n?n:pt),[2,Ft({appId:i,apiKey:a,measurementId:o},s,u,t)]}))}))}function Ft(e,t,n,r){var i=t.throttleEndTimeMillis,a=t.backoffCount;return void 0===r&&(r=Vt),D(this,void 0,void 0,(function(){var t,o,s,u,c,l,f;return J(this,(function(d){switch(d.label){case 0:t=e.appId,o=e.measurementId,d.label=1;case 1:return d.trys.push([1,3,,4]),[4,Kt(n,i)];case 2:return d.sent(),[3,4];case 3:if(s=d.sent(),o)return wt.warn("Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID "+o+' provided in the "measurementId" field in the local Firebase config. ['+s.message+"]"),[2,{appId:t,measurementId:o}];throw s;case 4:return d.trys.push([4,6,,7]),[4,Pt(e)];case 5:return u=d.sent(),r.deleteThrottleMetadata(t),[2,u];case 6:if(c=d.sent(),!Qt(c)){if(r.deleteThrottleMetadata(t),o)return wt.warn("Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID "+o+' provided in the "measurementId" field in the local Firebase config. ['+c.message+"]"),[2,{appId:t,measurementId:o}];throw c}return l=503===Number(c.customData.httpStatus)?Object(K["e"])(a,r.intervalMillis,Rt):Object(K["e"])(a,r.intervalMillis),f={throttleEndTimeMillis:Date.now()+l,backoffCount:a+1},r.setThrottleMetadata(t,f),wt.debug("Calling attemptFetch again in "+l+" millis"),[2,Ft(e,f,n,r)];case 7:return[2]}}))}))}function Kt(e,t){return new Promise((function(n,r){var i=Math.max(t-Date.now(),0),a=setTimeout(n,i);e.addEventListener((function(){clearTimeout(a),r(Bt.create("fetch-throttle",{throttleEndTimeMillis:t}))}))}))}function Qt(e){if(!(e instanceof K["c"])||!e.customData)return!1;var t=Number(e.customData["httpStatus"]);return 429===t||500===t||503===t||504===t}var Ut=function(){function e(){this.listeners=[]}return e.prototype.addEventListener=function(e){this.listeners.push(e)},e.prototype.abort=function(){this.listeners.forEach((function(e){return e()}))},e}();
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(){return D(this,void 0,void 0,(function(){var e;return J(this,(function(t){switch(t.label){case 0:return Object(K["l"])()?[3,1]:(wt.warn(Bt.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),[2,!1]);case 1:return t.trys.push([1,3,,4]),[4,Object(K["n"])()];case 2:return t.sent(),[3,4];case 3:return e=t.sent(),wt.warn(Bt.create("indexeddb-unavailable",{errorInfo:e}).message),[2,!1];case 4:return[2,!0]}}))}))}function zt(e,t,n,r,i){return D(this,void 0,void 0,(function(){var a,o,s,u,c,l,f;return J(this,(function(d){switch(d.label){case 0:return a=jt(e),a.then((function(t){n[t.measurementId]=t.appId,e.options.measurementId&&t.measurementId!==e.options.measurementId&&wt.warn("The measurement ID in the local Firebase config ("+e.options.measurementId+") does not match the measurement ID fetched from the server ("+t.measurementId+"). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.")})).catch((function(e){return wt.error(e)})),t.push(a),o=Lt().then((function(e){return e?r.getId():void 0})),[4,Promise.all([a,o])];case 1:return s=d.sent(),u=s[0],c=s[1],i("js",new Date),f={},f[dt]="firebase",f.update=!0,l=f,null!=c&&(l[ft]=c),i(ut.CONFIG,u.measurementId,l),[2,u.measurementId]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
